...
//    private DataSource dataSource;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers( "/detail-contract/**", "/contract/paid-customer").access("hasRole('ROLE_ADMIN')");
        // Trang /userInfo yêu cầu phải login với vai trò ROLE_USER hoặc ROLE_ADMIN.
        // Nếu chưa login, nó sẽ redirect tới trang /login.
        http.authorizeRequests().antMatchers("/customer/**", "/employee/**", "/facility/**", "/contract/**").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");
